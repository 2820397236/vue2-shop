    ...
    <section id='foot_guide'>
    	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="position:absolute;width:0;height:0">
	    	<defs>
				...
				<symbol viewBox="0 0 40 40" id="findActive"><defs><linearGradient id="discover.5811137_a" x1="50%" x2="50%" y1="100%" y2="0%"><stop offset="0%" stop-color="#FFFFFF"></stop><stop offset="100%" stop-color="#FFFFFF"></stop></linearGradient></defs><g fill="none" fill-rule="evenodd"><path fill="url(#discover.5811137_a)" d="M20 40c11.046 0 20-8.954 20-20S31.046 0 20 0 0 8.954 0 20s8.954 20 20 20z"></path><path fill="#fc3c3f" d="M12.79 28.126c-1.515.68-2.169.016-1.462-1.484l3.905-8.284c.47-.999 1.665-2.198 2.66-2.675l8.484-4.064c1.497-.717 2.153-.08 1.46 1.435l-3.953 8.64c-.46 1.006-1.647 2.186-2.655 2.64l-8.44 3.792z"></path><path fill="url(#discover.5811137_a)" d="M6.482 5.44c-.684-.294-.678-.764 0-1.055L11.54 2.45c.517-.198.936.085.936.65v3.625c0 .558-.412.852-.936.65L6.48 5.44z" transform="rotate(-45 34.258 3.92)"></path></g></symbol>
        ...
        <section @click = "gotoAddress({path: '/shop?id=2'})" class="guide_item">
            <svg class="icon_style">
        ...
        <section @click = "gotoAddress({path: '/analytics'})" class="guide_item" :class="$route.path.indexOf('analytics') !== -1? 'active' : ''">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('analytics') !== -1? '#findActive' : '#find'"></use>
            </svg>
            <span>统计</span>
        </section>
        
        <section @click = "gotoAddress('/shop?id=2')" class="guide_item" :class="$route.path.indexOf('shop') !== -1? 'active' : ''">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('shop') !== -1? '#profileActive' : '#profile'"></use>
            </svg>
            <span>我的</span>
        </section>
    </section>
